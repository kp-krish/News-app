...
export class news extends Component {
    ...
    async componentDidMount(){
      let url=`https://newsapi.org/v2/top-headlines?country=in&apiKey=994e1c5fa8da4377a3b2f68413836e67&page=1&pageSize=${this.props.pageSize}`
    ...
    handlePrevClick = async ()=>{
      let url = `https://newsapi.org/v2/top-headlines?country=in&apikey=994e1c5fa8da4377a3b2f68413836e67&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
      this.setState({loading: true});
      let data = await fetch(url);
      let parsedData = await data.json()
      this.setState({
